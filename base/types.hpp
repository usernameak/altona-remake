...
// #define _____STRING2(x) #x
// #define _____STRING(x) _____STRING2(x)

// #pragma message(_____STRING(sCONFIG_RENDER_OGL2))
...
// #pragma message("using 16 bit sChar")
...
protected:
  ...
  Type Storage[Max_];
public:                                 // das ganze rumgescope ist f�r den PS3-compiler...
  typedef typename sRemovePtrType<Type>::Type ElementType;
  enum { SIZE = Max_ };
