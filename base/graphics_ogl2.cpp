...
void sGeometry::Draw() {
  sDPrintF(L"[stub] sGeometry::Draw() is not implemented on Linux\n");
}

void sGeometry::Draw(const sGeometryDrawInfo &di) {
  sDPrintF(L"[stub] sGeometry::Draw(const sGeometryDrawInfo &di) is not implemented on Linux\n");
}
...
{
  sFatal(L"[stub] void sEnableGraphicsStats(sBool enable)");
}
