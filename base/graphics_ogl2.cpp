...
void ResizeGFX(sInt x,sInt y)
{
  /*// TODO TODO TODO TODO TODO FIX THIS SHIT
  glGetRenderbufferParameteriv(GL_RENDERBUFFER, GL_RENDERBUFFER_WIDTH, &x);
  glGetRenderbufferParameteriv(GL_RENDERBUFFER, GL_RENDERBUFFER_HEIGHT, &y);
...
void sGeometry::Draw() {
  sFatal(L"sGeometry::Draw is not implemented");
  exit(1);
}
